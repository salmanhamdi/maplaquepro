  ...
  describe("règles : un statut « active » ne rend jamais utilisable une valeur À VALIDER", () => {
    ...
    it("PriceRules", () => {
      const r = computePrice({
        rules: { id: "p", base: aValider(), byVariant: {}, byThickness: {}, byFormat: {}, customDimensionPricing: { etat: "A_VALIDER" }, byWorkflow: {}, byMounting: {}, artworkProcessingFee: aValider(), quantityTiers: { etat: "SANS_OBJET" }, vatRate: aValider(), pricingStatus: "active" },
        variantId: "v",
        thicknessId: "th_3_0",
